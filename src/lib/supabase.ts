...
// WICHTIG: Für den Client-Client (createClient) MUSS der Anon-Key (startet mit eyJ...) genutzt werden.
// Der 'sb_publishable' Key ist oft für spezielle Auth-UI-Bibliotheken, aber nicht für @supabase/supabase-js Standard.
